...
1. Speech-to-Text (STT) Extract audio, convert spoken content into text, and clean it for downstream analysis.
2. NLP Processing Split text into meaningful chunks and generate semantic embeddings for retrieval.
